...
import { MailTools, mailToolDefinitions, type ListMessagesInput, type GetMessageInput } from './mail.js';
import { SharePointTools, sharePointToolDefinitions, type ListSitesInput, type ListDrivesInput, type ListChildrenInput, type GetFileInput } from './sharepoint.js';
...
export class ToolExecutor {
  ...
  constructor(graphClient: GraphClient) {
    this.mailTools = new MailTools(graphClient);
